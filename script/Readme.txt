==Steps
  1. forager
     ...
     steps:
      ...
      4. 将格式化的数据复制到wenba_post_format表
      5. 运行migrator.rb将数据移植到common: baoxian028/script/export/migrator.rb
          注意： migrator.rb 会同时将hexun_post_format 和wenba_post_format的数据迁移过去
